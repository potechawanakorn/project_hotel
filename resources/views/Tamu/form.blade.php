      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tambah Data tamu</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="card-body">
        <form method="POST" action="/tamu">
            ...
            <div class="mb-3">
              ...
              <input type="date" name="jumlah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>

            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">booking</label>
              <select name="booking" class="form-control" id="">
                <option value="">-Pilih kamar-</option>
                @foreach($booking as $data)
                <option value="{{$data->id}}">{{$data->kode}} - {{$data->booking}}</option>
                @endforeach
              </select>
            </div>
